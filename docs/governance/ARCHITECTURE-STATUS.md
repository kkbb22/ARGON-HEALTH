...
## Status
GOVERNANCE RECORD. Dated 2026-08-27, last content-updated 2026-09-02,
repository-consolidated 2026-09-05 (see
`docs/audit/CONSOLIDATION-DECISIONS.md` — the consolidation changed file
locations and removed duplicates; it did not change any status value
below). This document IS the status board — it has no separate "status"
field of its own beyond being current as of this date.

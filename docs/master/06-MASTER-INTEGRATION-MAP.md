...
## Related ADRs
ADR-016 (messaging: Pub/Sub primary, RabbitMQ conditional —
`docs/adr/ADR-MESSAGING-PLATFORM.md`), ADR-018 (FHIR baseline corrected
to R4/R4B), ADR-019 (this document's technology content is subordinate
to ADR-000's trigger table — `docs/adr/ADR-019-RECONCILIATION-WITH-ADR-000.md`).

...
## Related ADRs
ADR-014 (this stack baseline, RESOLVED by ADR-019), ADR-016 (messaging),
ADR-017 (IaC), ADR-018 (FHIR), ADR-019 (subordinates this entire document
to ADR-000's trigger table — see

...
## Scope
40 domains, grouped by function. **Tier 1** domains (the ones most other
...
## Related ADRs
None — the GAP-011 CoverageTerms/currency additions (2026-09-02, under
ADR-020) elaborate the existing Insurance/Billing domains; no new
technology or architecture decision required.

## Unknowns
UNKNOWN — REQUIRES EVIDENCE whether any of these 40 domains has a partial
...
## Definition of Done
All 40 domains have all 15 fields populated with real content (verified
above — Tier 1: 12 domains full depth; Tier 2: 28 domains compact-complete

...
## 19. Interoperability
FHIR R5 (R4/R4B compatible), HL7 v2, DICOM/DICOMweb, IHE profiles, all
behind one Interoperability Layer — `06-MASTER-INTEGRATION-MAP.md`.
...
Storage, Secret Manager/KMS, Cloud Armor/Cloudflare, Terraform, GitHub
Actions — `13-MASTER-INFRASTRUCTURE-ARCHITECTURE.md`.
